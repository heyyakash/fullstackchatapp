...
const Chatbox = ({username,message,direction}:{username:string,message:string,direction:string}) => {
  return (
    <div className={`max-w-[50%] mt-2 clear-both float-${direction} w-auto h-[50px] bg-white/20 text-white overflow-hidden flex items-center ${direction==="right"?"flex-row-reverse":""} rounded-xl`}>
